...
import com.varun.aaadmin.adapter.CategoryAdapter
import com.varun.aaadmin.databinding.FragmentCategoryBinding
...
class CategoryFragment : Fragment() {
    ...
    private var launchGalleryActivity = registerForActivityResult(
        ...
        if(it.resultCode == Activity.RESULT_OK){
            ...
            binding.imageView2.setImageURI(imageUrl)
        }
    }
    ...
    private fun storeData(categoryName: String, url: String) {
        ...
        db.collection("categories").add(data)
            .addOnSuccessListener {
                dialog.dismiss()
                binding.imageView2.setImageDrawable(resources.getDrawable(R.drawable.avatar))
